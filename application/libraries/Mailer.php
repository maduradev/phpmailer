...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'rofiqiachyasir@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Yasir'; // Isikan dengan nama pengirim
    protected $password = 'ljfplndscklfkrpy'; // Isikan dengan password email pengirim
